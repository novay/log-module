...
<form action="{{route('activity')}}" method="get">
    <div class="row mb-3">
        @if(in_array('description',explode(',', 'description,user,method,route,ip')))
        ...
        @endif
        @if(in_array('user',explode(',', 'description,user,method,route,ip')))
            <div class="col-12 col-sm-4 col-lg-2 mb-2">
        ...
        @endif
        @if(in_array('method',explode(',', 'description,user,method,route,ip')))
            <div class="col-12 col-sm-4 col-lg-2 mb-2">
        ...
        @endif
        @if(in_array('route',explode(',', 'description,user,method,route,ip')))
            <div class="col-12 col-sm-4 col-lg-2 mb-2">
                <input type="text" name="route" class="form-control" value="{{request()->get('route') ? request()->get('route'):null}}" placeholder="Route">
            </div>
        @endif
        @if(in_array('ip',explode(',', 'description,user,method,route,ip')))
            <div class="col-12 col-sm-4 col-lg-2 mb-2">
        ...
        @endif
        @if(in_array('description',explode(',', 'description,user,method,route,ip'))||in_array('user',explode(',', 'description,user,method,route,ip')) ||in_array('method',explode(',', 'description,user,method,route,ip')) || in_array('route',explode(',', 'description,user,method,route,ip')) || in_array('ip',explode(',', 'description,user,method,route,ip')))
            <div class="col-12 col-sm-4 col-lg-2 mb-2">
